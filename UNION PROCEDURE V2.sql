...
--*******************************************************************
 ...
 DROP PROCEDURE UPDATEAR_TABLAS
...
CREATE PROCEDURE PROCEDIMIENTO_ADATA
AS
...
NULL, NULL,	 NULL,	 NULL,	 NULL,	 COD_UNICO,	 '1',	 DBO.TRIM(TI_LIQN)+DBO.TRIM(TI_LIQN_DE)
FROM STB_FINAL

SELECT * FROM DATA1908
...
SELECT * FROM DATA1908 A JOIN UNIDADES B ON A.COD_UNI = B.COD_UNI

SELECT BAR_UNI FROM DATA1908
...
SELECT MONTO FROM DATA1908 WHERE MONTO IS NOT NULL

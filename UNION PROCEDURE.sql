...
ALTER TABLE RCOBRE_ADSL ADD clasif2 NVARCHAR(250)ALTER TABLE RCOBRE_ADSL ADD modrutas NVARCHAR(250)
...
-- ELIMINAR LOS REGISTROS CON LOS CAMPOS DE CODSEG Y AREA QUE TENGAN LAS SIGUIENTES VARIABLES
DELETE FROM RCOBRE_ADSL WHERE CODSEG IN ('0','00','1','2','3','4','5','6','7') AND DBO.TRIM(AREA) = 'L'
...
AND DAY(RE_FE_REPO - FE_LIQU)-1 >= 0  AND DAY(RE_FE_REPO - FE_LIQU)-1 <= 30 AND MODRUTAS = '0' AND MODARM = '0' AND INSMDF = '0'
...
-- CUANDO EL CTECNICO NO TIENE LAS INICIALES NO SE PUEDE SACAR DE QUE CONTRATA SON

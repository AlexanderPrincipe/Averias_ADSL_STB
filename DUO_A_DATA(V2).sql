...
----- MONTO ADSL
SELECT DIF, ROUND(SUM(MONTO),2) FROM (
SELECT DIF, PRECIO, BAR_UNI, PRECIO*BAR_TOT AS MONTO FROM DATA1908 WHERE DIF IN ('AVERIAS ADSL', 'REITERADAS ADSL') AND PRECIO IS NOT NULL) A
GROUP BY DIF

----- MONTO STB
SELECT DIF, ROUND(SUM(MONTO),2) FROM (
SELECT DIF, PRECIO, BAR_UNI, PRECIO*BAR_UNI AS MONTO FROM DATA1908 WHERE DIF IN ('AVERIAS STB', 'REITERADAS STB') AND PRECIO IS NOT NULL) A
GROUP BY DIF

-- AVERIAS ADSL Y REITERADAS ADSL
SELECT DIF, CONTRA,ROUND(SUM(PRECIO*BAR_UNI),2) AS MONTO FROM DATA1908 GROUP BY DIF, CONTRA, BAR_UNI, PRECIO
HAVING PRECIO IS NOT NULL AND DIF IN ('AVERIAS ADSL', 'REITERADAS ADSL')

-- AVERIAS STB Y REITERADAS STB
SELECT  DIF, CONTRA,ROUND(SUM(PRECIO*BAR_UNI),2) FROM DATA1908 GROUP BY DIF, CONTRA, BAR_UNI, PRECIO
HAVING PRECIO IS NOT NULL AND DIF IN ('AVERIAS STB', 'REITERADAS STB')
